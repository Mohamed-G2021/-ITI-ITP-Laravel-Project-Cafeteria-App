...
<div class="container">
    ...
    <br>
    <div class="">
        <a href="{{route('products.index')}}" class="btn btn-primary text-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
