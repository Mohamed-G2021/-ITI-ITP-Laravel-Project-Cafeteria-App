...
class AdminOrderProductController extends Controller
{
    ...
    protected function cust(Request $request)
    {
        ...
        return view('admin-dashboard.admin-order-products.index',  ['user_id' => $id, 'user_orders' => $user_orders]);
    ...
    public function index(Request $request)
    {
        ...
        return view(
            'admin-dashboard.OrderProducts.index',
    ...
    public  function store(Request $request)
    {
        ...
        return view('admin-dashboard.OrderProducts.index', ['cart' => $cart, 'users'=>$users,'products'=>$products]);
    ...
    public function show($id)
    {
        ...
        dd($product);
        return view('admin-dashboard.product.show', compact('product'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $Products = Product::all();
        $amount = $this->calculate_amount();
        return redirect(url('admin/dashboard/admin-order-products'));
    }
